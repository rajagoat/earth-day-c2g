...
<h1>More User Information</h1>
            ...
            <p>Agree to rules + legal information</p>
            <p>Availabilities</p>
            <h2>Gleaners need:</h2>
            <p>Select a group from the list (ideally 
                sorted by locality)
            </p>
            <p>distance (range) they're willing to go</p>
            <h2>Farmers need:</h2>
            <p>Maximum capacity of produce they can collect</p>
            <h2>Food banks need:</h2>
            <p>distance (range) they're willing to go</p>
            <p>Maximum capacity of produce they can collect</p>
*/
    ...
    return (
        <>
            <div className="mx-12 max-w-7xl py-12 pb-0 px-4 sm:px-0 lg:py-12 lg:px-0 lg:pb-0">
                ...
                <h5 className="text-lg">Please fill out the following information to finish setting up your account.</h5>
                <h5 className="text-lg">Fields marked with a * are required.</h5>
            </div>
