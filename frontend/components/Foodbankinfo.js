...
export const Foodbankinfo = () => {
  ...
  return (
    <>
      ...
      >
        <p class="text-sm font-medium leading-none text-white">Food Bank Pickup Details</p>
      </button>
      {showModal ? (
        <>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3x1">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t ">
                  <h3 className="text-1xl font=semibold">Rate Gleaner</h3>
                  <button
                ...
                <div className="relative p-6 flex-auto">
                  <form className="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 w-full">
                    <label className="block text-black text-sm font-bold mb-1">
                      FoodBank in Montrial expected to arrive on 12th Nov, between 1pm to 5pm
                    </label>
                  </form>
                </div>
