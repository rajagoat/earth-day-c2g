...
export const Notification = ()=>{
  return (
    <div class="bg-white/60 hover:bg-white/80 hover:shadow-lg transition duration-150 ease-linear backdrop-blur-xl z-20 max-w-md absolute right-5 top-20 rounded-lg p-6 shadow">
    <h1 class="text-xl text-slate-700 font-medium">Welcome back, Gleaner 👋</h1>
